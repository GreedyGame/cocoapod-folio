...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.0.zip'}
  #
  ...
  # s.public_header_files = 'Pod/Classes/**/*.h'
    #s.vendored_frameworks = 'ios-native-plugin-1.0.0/commons.framework', 'ios-native-plugin-1.0.0/imageprocessing.framework', 'ios-native-plugin-1.0.0/ios.framework'
    # s.frameworks = 'commons', 'imageprocessing', 'ios'
  # s.dependency 'AFNetworking', '~> 2.3'
  s.vendored_frameworks   = 'ios-native-plugin-1.0.0/commons.framework', 'ios-native-plugin-1.0.0/imageprocessing.framework', 'ios-native-plugin-1.0.0/greedygame.framework'
