...
#
 ...
 Pod::Spec.new do |s|
  ...
  s.swift_version         = '4.2'
  s.description           = 'A native ios swift library for integrating greedygame ads to your apps. For more info visit www.greedygame.com. This version is to be used in case you 				are using XCode 10.2, 10.2.1 and 10.3.'
  ...
  s.source                = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.5.1.zip'}
  s.ios.deployment_target = '9.0'
  s.vendored_frameworks   = 'iOS-native-plugin-1.0.5.1/commons.framework', 'iOS-native-plugin-1.0.5.1/imageprocessing.framework', 'iOS-native-plugin-1.0.5.1/greedygame.framework'
