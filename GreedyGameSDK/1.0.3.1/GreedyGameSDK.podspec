...
#
 ...
 Pod::Spec.new do |s|
  ...
  s.swift_version         = '5'
  s.description           = 'A native ios swift library for integrating greedygame ads to your apps. For more info visit www.greedygame.com. This version is to be used in case you 				are using XCode 10.2 and 10.2.1.For low version use sdk 1.0.3'
  ...
  s.source                = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.3.1.zip'}
  s.ios.deployment_target = '8.0'
  s.vendored_frameworks   = 'iOS-native-plugin-1.0.3.1/commons.framework', 'iOS-native-plugin-1.0.3.1/imageprocessing.framework', 'iOS-native-plugin-1.0.3.1/greedygame.framework'
