...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/b2.0.0.1.zip'}
  s.ios.deployment_target = '8.0'
  s.vendored_frameworks   = 'ios-native-plugin-b2.0.0.1/commons.framework', 'ios-native-plugin-b2.0.0.1/imageprocessing.framework', 'ios-native-plugin-b2.0.0.1/greedygame.framework'
