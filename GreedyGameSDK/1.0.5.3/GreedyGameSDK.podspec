...
#
 ...
 Pod::Spec.new do |s|
  ...
  s.swift_version         = '5'
  s.description           = 'A native ios swift library for integrating greedygame ads to your apps. For more info visit www.greedygame.com. This version is to be used in case you 				are using XCode 11.2, 11.2.1 and 11.3.'
  ...
  s.source                = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.5.3.zip'}
  s.ios.deployment_target = '9.0'
  s.vendored_frameworks   = 'iOS-native-plugin-1.0.5.3/commons.framework', 'iOS-native-plugin-1.0.5.3/imageprocessing.framework', 'iOS-native-plugin-1.0.5.3/greedygame.framework'
