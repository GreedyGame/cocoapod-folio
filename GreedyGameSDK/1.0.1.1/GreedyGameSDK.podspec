...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.1.1.zip'}
  s.ios.deployment_target = '8.0'
  s.vendored_frameworks   = 'ios-native-plugin-1.0.1.1/commons.framework', 'ios-native-plugin-1.0.1.1/imageprocessing.framework', 'ios-native-plugin-1.0.1.1/greedygame.framework'
