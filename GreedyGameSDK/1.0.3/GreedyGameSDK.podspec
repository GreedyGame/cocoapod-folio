...
#
 ...
 Pod::Spec.new do |s|
  ...
  s.source                = { :http => 'https://github.com/GreedyGame/ios-native-plugin/archive/1.0.3.zip'}
  s.ios.deployment_target = '8.0'
  s.vendored_frameworks   = 'iOS-native-plugin-1.0.3/commons.framework', 'iOS-native-plugin-1.0.3/imageprocessing.framework', 'iOS-native-plugin-1.0.3/greedygame.framework'
